...
<xsl:param name="next"/>
<xsl:param name="toc"/>
<xsl:param name="images" select="'../misc/image/'"/>
	...
	<tr>
		<td>
			<address><font size="2">
				...
				<br/>
				<a href="http://se.inf.ethz.ch/eiffelmedia">http://se.inf.ethz.ch/eiffelmedia</a> (login: eiffelmedia pw: EIFFEL)
				<br/>
				<xsl:apply-templates select="gobodoc:chapterinfo/gobodoc:date" mode="footer"/>
			</font></address>
		</td>
		<td align="right" valign="top">
			<a href="http://se.inf.ethz.ch/eiffelmedia">
...
<xsl:template match="gobodoc:indexlink">
	<a>
...
<xsl:template match="gobodoc:toplink">
	<a href="#top_of_page">
     <font color="#CC6600">
           top
     </font>
