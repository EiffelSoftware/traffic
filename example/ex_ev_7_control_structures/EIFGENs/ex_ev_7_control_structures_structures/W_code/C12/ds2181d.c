...
static int16 gen_type0_2181 [] = {0,2180,743,-1};
static int16 gen_type1_2181 [] = {0,2180,743,-1};
static int16 gen_type2_2181 [] = {0,2180,743,-1};
static int16 gen_type3_2181 [] = {0,2180,743,-1};


static struct desc_info desc_2181[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2180, gen_type0_2181}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2180, gen_type1_2181}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2180, gen_type2_2181}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2180, gen_type3_2181}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2181(void);
void Init2181(void)
{
	IDSC(desc_2181, 0, RTUD(2180));
	IDSC(desc_2181 + 1, 1, RTUD(2180));
}
