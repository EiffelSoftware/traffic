/*
 * Class KL_PART_COMPARATOR [BOOLEAN]
 */
...
static int16 gen_type0_2182 [] = {0,2181,743,-1};
static int16 gen_type1_2182 [] = {0,2181,743,-1};
static int16 gen_type2_2182 [] = {0,2181,743,-1};
static int16 gen_type3_2182 [] = {0,2181,743,-1};


static struct desc_info desc_2182[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2181, gen_type0_2182}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2181, gen_type1_2182}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2181, gen_type2_2182}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2181, gen_type3_2182}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 26172, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2182(void);
void Init2182(void)
{
	IDSC(desc_2182, 0, RTUD(2181));
	IDSC(desc_2182 + 1, 1, RTUD(2181));
	IDSC(desc_2182 + 31, 1836, RTUD(2181));
}
