...
static int16 gen_type0_2192 [] = {0,2191,-8,1,-1};
static int16 gen_type1_2192 [] = {0,2191,-8,1,-1};
static int16 gen_type2_2192 [] = {0,2191,-8,1,-1};
static int16 gen_type3_2192 [] = {0,2191,-8,1,-1};
static int16 gen_type4_2192 [] = {0,2191,-8,1,-1};


static struct desc_info desc_2192[] = {
	{(BODY_INDEX) 29688, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2191, gen_type0_2192}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2191, gen_type1_2192}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2191, gen_type2_2192}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2191, gen_type3_2192}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2191, gen_type4_2192}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29691, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
};
extern void Init2192(void);
void Init2192(void)
{
	IDSC(desc_2192, 0, RTUD(2191));
	IDSC(desc_2192 + 1, 1, RTUD(2191));
	IDSC(desc_2192 + 31, 1700, RTUD(2191));
	IDSC(desc_2192 + 32, 1654, RTUD(2191));
	IDSC(desc_2192 + 36, 1589, RTUD(2191));
	IDSC(desc_2192 + 41, 1590, RTUD(2191));
}
