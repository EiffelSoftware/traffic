...
static int16 gen_type0_2183 [] = {0,2182,743,-1};
static int16 gen_type1_2183 [] = {0,2182,743,-1};
static int16 gen_type2_2183 [] = {0,2182,743,-1};
static int16 gen_type3_2183 [] = {0,2182,743,-1};
static int16 gen_type4_2183 [] = {0,2182,743,-1};
static int16 gen_type5_2183 [] = {0,2175,743,-1};


static struct desc_info desc_2183[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2182, gen_type0_2183}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2182, gen_type1_2183}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2182, gen_type2_2183}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2182, gen_type3_2183}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2182, gen_type4_2183}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2175, gen_type5_2183}, 
...
void Init2183(void)
{
	IDSC(desc_2183, 0, RTUD(2182));
	IDSC(desc_2183 + 1, 1, RTUD(2182));
	IDSC(desc_2183 + 31, 1700, RTUD(2182));
	IDSC(desc_2183 + 32, 1648, RTUD(2182));
	IDSC(desc_2183 + 39, 1654, RTUD(2182));
	IDSC(desc_2183 + 43, 1590, RTUD(2182));
}
