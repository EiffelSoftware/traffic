...
static int16 gen_type0_2175 [] = {0,2174,743,-1};
static int16 gen_type1_2175 [] = {0,2174,743,-1};
static int16 gen_type2_2175 [] = {0,2174,743,-1};
static int16 gen_type3_2175 [] = {0,2174,743,-1};
static int16 gen_type4_2175 [] = {0,2174,743,-1};
static int16 gen_type5_2175 [] = {0,2175,743,-1};


static struct desc_info desc_2175[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2174, gen_type0_2175}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2174, gen_type1_2175}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2174, gen_type2_2175}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2174, gen_type3_2175}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2174, gen_type4_2175}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2175, gen_type5_2175}, 
...
void Init2175(void)
{
	IDSC(desc_2175, 0, RTUD(2174));
	IDSC(desc_2175 + 1, 1, RTUD(2174));
	IDSC(desc_2175 + 31, 1700, RTUD(2174));
	IDSC(desc_2175 + 32, 1648, RTUD(2174));
	IDSC(desc_2175 + 39, 1654, RTUD(2174));
	IDSC(desc_2175 + 43, 1590, RTUD(2174));
}
