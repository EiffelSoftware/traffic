...
static int16 gen_type0_2180 [] = {0,2179,743,-1};
static int16 gen_type1_2180 [] = {0,2179,743,-1};
static int16 gen_type2_2180 [] = {0,2179,743,-1};
static int16 gen_type3_2180 [] = {0,2179,743,-1};
static int16 gen_type4_2180 [] = {0,2179,743,-1};


static struct desc_info desc_2180[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2179, gen_type0_2180}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2179, gen_type1_2180}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2179, gen_type2_2180}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2179, gen_type3_2180}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29149, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2179, gen_type4_2180}, 
	{(BODY_INDEX) 29162, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29163, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
};
extern void Init2180(void);
void Init2180(void)
{
	IDSC(desc_2180, 0, RTUD(2179));
	IDSC(desc_2180 + 1, 1, RTUD(2179));
	IDSC(desc_2180 + 31, 1654, RTUD(2179));
	IDSC(desc_2180 + 35, 1700, RTUD(2179));
	IDSC(desc_2180 + 36, 1705, RTUD(2179));
	IDSC(desc_2180 + 38, 1590, RTUD(2179));
}
