...
static int16 gen_type0_2176 [] = {0,2175,743,-1};
static int16 gen_type1_2176 [] = {0,2175,743,-1};
static int16 gen_type2_2176 [] = {0,2175,743,-1};
static int16 gen_type3_2176 [] = {0,2175,743,-1};


static struct desc_info desc_2176[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2175, gen_type0_2176}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2175, gen_type1_2176}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2175, gen_type2_2176}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2175, gen_type3_2176}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26492, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2176(void);
void Init2176(void)
{
	IDSC(desc_2176, 0, RTUD(2175));
	IDSC(desc_2176 + 1, 1, RTUD(2175));
	IDSC(desc_2176 + 31, 1701, RTUD(2175));
}
