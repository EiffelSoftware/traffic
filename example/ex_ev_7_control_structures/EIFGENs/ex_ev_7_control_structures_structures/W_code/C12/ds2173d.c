...
static int16 gen_type0_2173 [] = {0,2172,743,-1};
static int16 gen_type1_2173 [] = {0,2172,743,-1};
static int16 gen_type2_2173 [] = {0,2172,743,-1};
static int16 gen_type3_2173 [] = {0,2172,743,-1};
static int16 gen_type4_2173 [] = {0,2172,743,-1};


static struct desc_info desc_2173[] = {
	{(BODY_INDEX) 29148, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2172, gen_type0_2173}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2172, gen_type1_2173}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2172, gen_type2_2173}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2172, gen_type3_2173}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29149, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2172, gen_type4_2173}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
};
extern void Init2173(void);
void Init2173(void)
{
	IDSC(desc_2173, 0, RTUD(2172));
	IDSC(desc_2173 + 1, 1, RTUD(2172));
	IDSC(desc_2173 + 31, 1654, RTUD(2172));
	IDSC(desc_2173 + 35, 1700, RTUD(2172));
	IDSC(desc_2173 + 36, 1590, RTUD(2172));
}
