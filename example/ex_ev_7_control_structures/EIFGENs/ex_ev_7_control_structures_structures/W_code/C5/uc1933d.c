...
static struct desc_info desc_1933[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1932, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1932, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1932, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1932, (int16 *) 0}, 
...
void Init1933(void)
{
	IDSC(desc_1933, 0, RTUD(1932));
	IDSC(desc_1933 + 1, 1, RTUD(1932));
	IDSC(desc_1933 + 31, 1759, RTUD(1932));
}
