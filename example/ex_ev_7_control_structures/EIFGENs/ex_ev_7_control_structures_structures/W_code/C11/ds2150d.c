...
static int16 gen_type0_2150 [] = {0,2149,-8,1,-1};
static int16 gen_type1_2150 [] = {0,2149,-8,1,-1};
static int16 gen_type2_2150 [] = {0,2149,-8,1,-1};
static int16 gen_type3_2150 [] = {0,2149,-8,1,-1};
static int16 gen_type4_2150 [] = {0,2149,-8,1,-1};


static struct desc_info desc_2150[] = {
	{(BODY_INDEX) 29146, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2149, gen_type0_2150}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2149, gen_type1_2150}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2149, gen_type2_2150}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2149, gen_type3_2150}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29147, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2149, gen_type4_2150}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
};
extern void Init2150(void);
void Init2150(void)
{
	IDSC(desc_2150, 0, RTUD(2149));
	IDSC(desc_2150 + 1, 1, RTUD(2149));
	IDSC(desc_2150 + 31, 1654, RTUD(2149));
	IDSC(desc_2150 + 35, 1700, RTUD(2149));
	IDSC(desc_2150 + 36, 1590, RTUD(2149));
}
