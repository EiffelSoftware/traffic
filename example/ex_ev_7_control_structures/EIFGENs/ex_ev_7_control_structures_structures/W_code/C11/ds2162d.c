/*
 * Class DS_DYNAMIC_CURSOR [REFERENCE]
 */
...
static int16 gen_type0_2162 [] = {0,2161,-8,1,-1};
static int16 gen_type1_2162 [] = {0,2161,-8,1,-1};
static int16 gen_type2_2162 [] = {0,2161,-8,1,-1};
static int16 gen_type3_2162 [] = {0,2161,-8,1,-1};
static int16 gen_type4_2162 [] = {0,-8,1,-1};
static int16 gen_type5_2162 [] = {0,2150,-8,1,-1};


static struct desc_info desc_2162[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2161, gen_type0_2162}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2161, gen_type1_2162}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2161, gen_type2_2162}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2161, gen_type3_2162}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 28960, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28920, (BODY_INDEX) -1, (int16) -1, gen_type4_2162}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2150, gen_type5_2162}, 
...
void Init2162(void)
{
	IDSC(desc_2162, 0, RTUD(2161));
	IDSC(desc_2162 + 1, 1, RTUD(2161));
	IDSC(desc_2162 + 31, 1703, RTUD(2161));
	IDSC(desc_2162 + 33, 1649, RTUD(2161));
	IDSC(desc_2162 + 42, 1590, RTUD(2161));
}
