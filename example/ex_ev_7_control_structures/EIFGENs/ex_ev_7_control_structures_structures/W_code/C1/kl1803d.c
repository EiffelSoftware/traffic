...
static struct desc_info desc_1803[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1802, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1802, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1802, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1802, (int16 *) 0}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26136, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init1803(void);
void Init1803(void)
{
	IDSC(desc_1803, 0, RTUD(1802));
	IDSC(desc_1803 + 1, 1, RTUD(1802));
	IDSC(desc_1803 + 31, 1915, RTUD(1802));
}
