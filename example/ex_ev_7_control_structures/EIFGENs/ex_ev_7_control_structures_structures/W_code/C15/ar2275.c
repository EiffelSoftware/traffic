/*
 * Code for class ARRAYED_SET [INTEGER_32]
 */
...
extern void Fe6_owa(EIF_REFERENCE, EIF_UNION);
extern void Fe60btx(EIF_REFERENCE, EIF_UNION);
extern void Fe60zrj(EIF_REFERENCE, EIF_UNION);
...
void Fe6_owa (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_INTEGER_32_value
	...
	RTLU(SK_INT32,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("put", RTUD(2274), Current, 0, 1, 27586);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	if (tc3) {
		RTHOOK(3);
		ui4_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWPF(130, 1, dtype))(Current, ui4_1x);
	}
...
void Fe60btx (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION ui4_1x = {0, SK_INT32};
...
#define arg1 arg1x.value.EIF_INTEGER_32_value
	...
	RTLU(SK_INT32,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("extend", RTUD(2274), Current, 0, 1, 27587);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
void Fe60zrj (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION ui4_1x = {0, SK_INT32};
...
#define arg1 arg1x.value.EIF_INTEGER_32_value
	...
	RTLU(SK_INT32,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("prune", RTUD(2274), Current, 0, 1, 27588);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWPF(130, 2, dtype))(Current, ui4_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
