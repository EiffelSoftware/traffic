...
extern EIF_UNION Fn87xfe(EIF_REFERENCE, EIF_UNION);
extern EIF_UNION Fn85zmj(EIF_REFERENCE, EIF_UNION, EIF_UNION);
extern EIF_UNION Fn86mj5(EIF_REFERENCE, EIF_UNION, EIF_UNION);
extern void Fn887an(EIF_REFERENCE, EIF_UNION);
extern void Fn88kc0(EIF_REFERENCE, EIF_UNION, EIF_UNION, EIF_UNION, EIF_UNION, EIF_UNION);
extern void Fn89u79(EIF_REFERENCE, EIF_UNION, EIF_UNION, EIF_UNION);
extern EIF_UNION Fn869hs(EIF_REFERENCE, EIF_UNION, EIF_UNION, EIF_UNION, EIF_UNION);
...
EIF_UNION Fn87xfe (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("cloned_array", RTUD(2265), Current, 0, 1, 28022);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2265, 31, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		RTNHOOK(4);
		ur1 = RTCCL(Result);
		ur2 = RTCCL(arg1);
...
EIF_UNION Fn85zmj (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x)
{
	GTCX
	RTEX;
	EIF_UNION up1x = {0, SK_POINTER};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_INT32,&arg2);
	RTLU (SK_REF, &Current);
	RTEAA("make_from_array", RTUD(2265), Current, 0, 2, 28019);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	ui4_2 = ti4_2;
	ui4_3 = arg2;
	Result = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE, EIF_UNION, EIF_UNION, EIF_UNION, EIF_UNION)) RTWF(2265, 34, dtype))(Current, ur1x, ui4_1x, ui4_2x, ui4_3x)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_UNION Fn86mj5 (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_INT32, &loc1);
	RTLU(SK_INT32, &loc2);
	RTEAA("has", RTUD(2265), Current, 2, 2, 28020);
	RTGC;
	RTSA(Dtype(Current));
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	while (!((EIF_BOOLEAN)(loc1 > loc2))) {
		...
		RTHOOK(5);
		ui4_1 = loc1;
		ti4_1 = (((FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE, EIF_UNION)) RTVPF(102, 0, "item", arg1))(arg1, ui4_1x)).value.EIF_INTEGER_32_value);
		if ((EIF_BOOLEAN)(ti4_1 == arg2)) {
			RTHOOK(6);
...
void Fn887an (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	RTSN;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("clear_all", RTUD(2265), Current, 0, 1, 28024);
	RTGC;
	RTSA(Dtype(Current));
	RTSC;
	RTIV2(Current, RTAL);
...
void Fn88kc0 (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x, EIF_UNION arg3x, EIF_UNION arg4x, EIF_UNION arg5x)
{
	GTCX
	RTEX;
	EIF_UNION ur1x = {0, SK_REF};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_INT32,&arg5);
	RTLU (SK_REF, &Current);
	RTEAA("subcopy", RTUD(2265), Current, 0, 5, 28023);
	RTGC;
	RTSA(Dtype(Current));
	RTSC;
	RTIV2(Current, RTAL);
...
void Fn89u79 (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x, EIF_UNION arg3x)
{
	GTCX
	RTEX;
	EIF_UNION ui4_1x = {0, SK_INT32};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_INT32,&arg3);
	RTLU (SK_REF, &Current);
	RTEAA("resize", RTUD(2265), Current, 0, 3, 28025);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
EIF_UNION Fn869hs (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x, EIF_UNION arg3x, EIF_UNION arg4x)
{
	GTCX
	RTEX;
	EIF_UNION ur1x = {0, SK_REF};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_INT32,&arg4);
	RTLU (SK_REF, &Current);
	RTEAA("subarray", RTUD(2265), Current, 0, 4, 28021);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	RTHOOK(5);
	{
		static int16 typarr [] = {2265,1438,737,-1};
		int16 typres;
	...
	ui4_2 = arg3;
	ui4_3 = arg4;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION, EIF_UNION, EIF_UNION, EIF_UNION, EIF_UNION)) RTWF(2265, 36, dtype))(Current, ur1x, ur2x, ui4_1x, ui4_2x, ui4_3x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
		RTCT("array_not_void", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
