/*
 * Class SUBSET_STRATEGY_GENERIC [INTEGER_32]
 */
...
static int16 gen_type0_2281 [] = {0,2280,737,-1};
static int16 gen_type1_2281 [] = {0,2280,737,-1};
static int16 gen_type2_2281 [] = {0,2280,737,-1};
static int16 gen_type3_2281 [] = {0,2280,737,-1};


static struct desc_info desc_2281[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2280, gen_type0_2281}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2280, gen_type1_2281}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2280, gen_type2_2281}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2280, gen_type3_2281}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27137, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27138, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2281(void);
void Init2281(void)
{
	IDSC(desc_2281, 0, RTUD(2280));
	IDSC(desc_2281 + 1, 1, RTUD(2280));
	IDSC(desc_2281 + 31, 64, RTUD(2280));
}
