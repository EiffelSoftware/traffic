...
static int16 gen_type0_2286 [] = {0,2285,-8,1,-1};
static int16 gen_type1_2286 [] = {0,2285,-8,1,-1};
static int16 gen_type2_2286 [] = {0,2285,-8,1,-1};
static int16 gen_type3_2286 [] = {0,2285,-8,1,-1};


static struct desc_info desc_2286[] = {
	{(BODY_INDEX) 27276, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2285, gen_type0_2286}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2285, gen_type1_2286}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2285, gen_type2_2286}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2285, gen_type3_2286}, 
...
void Init2286(void)
{
	IDSC(desc_2286, 0, RTUD(2285));
	IDSC(desc_2286 + 1, 1, RTUD(2285));
	IDSC(desc_2286 + 31, 39, RTUD(2285));
	IDSC(desc_2286 + 39, 1840, RTUD(2285));
	IDSC(desc_2286 + 51, 163, RTUD(2285));
}
