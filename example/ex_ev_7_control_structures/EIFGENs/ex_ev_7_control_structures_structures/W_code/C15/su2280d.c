...
static int16 gen_type0_2280 [] = {0,2279,737,-1};
static int16 gen_type1_2280 [] = {0,2279,737,-1};
static int16 gen_type2_2280 [] = {0,2279,737,-1};
static int16 gen_type3_2280 [] = {0,2279,737,-1};


static struct desc_info desc_2280[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2279, gen_type0_2280}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2279, gen_type1_2280}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2279, gen_type2_2280}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2279, gen_type3_2280}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27133, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27134, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2280(void);
void Init2280(void)
{
	IDSC(desc_2280, 0, RTUD(2279));
	IDSC(desc_2280 + 1, 1, RTUD(2279));
	IDSC(desc_2280 + 31, 64, RTUD(2279));
}
