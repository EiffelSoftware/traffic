...
static int16 gen_type0_2279 [] = {0,2278,737,-1};
static int16 gen_type1_2279 [] = {0,2278,737,-1};
static int16 gen_type2_2279 [] = {0,2278,737,-1};
static int16 gen_type3_2279 [] = {0,2278,737,-1};


static struct desc_info desc_2279[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2278, gen_type0_2279}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2278, gen_type1_2279}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2278, gen_type2_2279}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2278, gen_type3_2279}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2279(void);
void Init2279(void)
{
	IDSC(desc_2279, 0, RTUD(2278));
	IDSC(desc_2279 + 1, 1, RTUD(2278));
}
