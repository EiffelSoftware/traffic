...
static struct desc_info desc_1895[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1894, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1894, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1894, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1894, (int16 *) 0}, 
...
void Init1895(void)
{
	IDSC(desc_1895, 0, RTUD(1894));
	IDSC(desc_1895 + 1, 1, RTUD(1894));
	IDSC(desc_1895 + 31, 1543, RTUD(1894));
	IDSC(desc_1895 + 32, 1558, RTUD(1894));
}
