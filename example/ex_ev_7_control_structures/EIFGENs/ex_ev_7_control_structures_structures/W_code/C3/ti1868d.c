...
static struct desc_info desc_1868[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1867, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1867, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1867, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1867, (int16 *) 0}, 
...
void Init1868(void)
{
	IDSC(desc_1868, 0, RTUD(1867));
	IDSC(desc_1868 + 1, 1, RTUD(1867));
	IDSC(desc_1868 + 31, 1692, RTUD(1867));
	IDSC(desc_1868 + 37, 1763, RTUD(1867));
}
