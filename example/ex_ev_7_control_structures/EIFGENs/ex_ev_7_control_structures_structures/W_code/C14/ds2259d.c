...
static int16 gen_type0_2259 [] = {0,2258,737,-1};
static int16 gen_type1_2259 [] = {0,2258,737,-1};
static int16 gen_type2_2259 [] = {0,2258,737,-1};
static int16 gen_type3_2259 [] = {0,2258,737,-1};
static int16 gen_type4_2259 [] = {0,2258,737,-1};
static int16 gen_type5_2259 [] = {0,2252,737,-1};


static struct desc_info desc_2259[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2258, gen_type0_2259}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2258, gen_type1_2259}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2258, gen_type2_2259}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2258, gen_type3_2259}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2258, gen_type4_2259}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2252, gen_type5_2259}, 
...
void Init2259(void)
{
	IDSC(desc_2259, 0, RTUD(2258));
	IDSC(desc_2259 + 1, 1, RTUD(2258));
	IDSC(desc_2259 + 31, 1700, RTUD(2258));
	IDSC(desc_2259 + 32, 1648, RTUD(2258));
	IDSC(desc_2259 + 39, 1654, RTUD(2258));
	IDSC(desc_2259 + 43, 1590, RTUD(2258));
}
