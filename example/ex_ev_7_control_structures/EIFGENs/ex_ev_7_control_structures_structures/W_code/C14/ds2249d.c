/*
 * Class DS_TABLE [REFERENCE, INTEGER_32]
 */
...
static int16 gen_type0_2249 [] = {0,2248,-8,1,737,-1};
static int16 gen_type1_2249 [] = {0,2248,-8,1,737,-1};
static int16 gen_type2_2249 [] = {0,2248,-8,1,737,-1};
static int16 gen_type3_2249 [] = {0,2248,-8,1,737,-1};
static int16 gen_type4_2249 [] = {0,-8,1,-1};
static int16 gen_type5_2249 [] = {0,2248,-8,1,737,-1};


static struct desc_info desc_2249[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2248, gen_type0_2249}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2248, gen_type1_2249}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2248, gen_type2_2249}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2248, gen_type3_2249}, 
	...
	{(BODY_INDEX) 29159, (BODY_INDEX) -1, (int16) -1, gen_type4_2249}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2248, gen_type5_2249}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
...
void Init2249(void)
{
	IDSC(desc_2249, 0, RTUD(2248));
	IDSC(desc_2249 + 1, 1, RTUD(2248));
	IDSC(desc_2249 + 31, 1654, RTUD(2248));
	IDSC(desc_2249 + 35, 1590, RTUD(2248));
	IDSC(desc_2249 + 36, 1911, RTUD(2248));
	IDSC(desc_2249 + 37, 1700, RTUD(2248));
	IDSC(desc_2249 + 38, 1843, RTUD(2248));
}
