/*
 * Class DS_TABLE [BOOLEAN, REFERENCE]
 */
...
static int16 gen_type0_2232 [] = {0,2231,743,-8,2,-1};
static int16 gen_type1_2232 [] = {0,2231,743,-8,2,-1};
static int16 gen_type2_2232 [] = {0,2231,743,-8,2,-1};
static int16 gen_type3_2232 [] = {0,2231,743,-8,2,-1};
static int16 gen_type4_2232 [] = {0,743,-1};
static int16 gen_type5_2232 [] = {0,2231,743,-8,2,-1};


static struct desc_info desc_2232[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2231, gen_type0_2232}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2231, gen_type1_2232}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2231, gen_type2_2232}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2231, gen_type3_2232}, 
	...
	{(BODY_INDEX) 29157, (BODY_INDEX) -1, (int16) -1, gen_type4_2232}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2231, gen_type5_2232}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
...
void Init2232(void)
{
	IDSC(desc_2232, 0, RTUD(2231));
	IDSC(desc_2232 + 1, 1, RTUD(2231));
	IDSC(desc_2232 + 31, 1654, RTUD(2231));
	IDSC(desc_2232 + 35, 1590, RTUD(2231));
	IDSC(desc_2232 + 36, 1911, RTUD(2231));
	IDSC(desc_2232 + 37, 1700, RTUD(2231));
	IDSC(desc_2232 + 38, 1843, RTUD(2231));
}
