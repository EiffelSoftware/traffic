...
static int16 gen_type0_2253 [] = {0,2252,737,-1};
static int16 gen_type1_2253 [] = {0,2252,737,-1};
static int16 gen_type2_2253 [] = {0,2252,737,-1};
static int16 gen_type3_2253 [] = {0,2252,737,-1};


static struct desc_info desc_2253[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2252, gen_type0_2253}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2252, gen_type1_2253}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2252, gen_type2_2253}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2252, gen_type3_2253}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26493, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2253(void);
void Init2253(void)
{
	IDSC(desc_2253, 0, RTUD(2252));
	IDSC(desc_2253 + 1, 1, RTUD(2252));
	IDSC(desc_2253 + 31, 1701, RTUD(2252));
}
