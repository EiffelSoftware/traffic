...
static int16 gen_type0_2218 [] = {0,2217,-8,1,-1};
static int16 gen_type1_2218 [] = {0,2217,-8,1,-1};
static int16 gen_type2_2218 [] = {0,2217,-8,1,-1};
static int16 gen_type3_2218 [] = {0,2217,-8,1,-1};
static int16 gen_type4_2218 [] = {0,2217,-8,1,-1};
static int16 gen_type5_2218 [] = {0,2152,-8,1,-1};


static struct desc_info desc_2218[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2217, gen_type0_2218}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2217, gen_type1_2218}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2217, gen_type2_2218}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2217, gen_type3_2218}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2217, gen_type4_2218}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2152, gen_type5_2218}, 
...
void Init2218(void)
{
	IDSC(desc_2218, 0, RTUD(2217));
	IDSC(desc_2218 + 1, 1, RTUD(2217));
	IDSC(desc_2218 + 31, 1590, RTUD(2217));
	IDSC(desc_2218 + 32, 1700, RTUD(2217));
	IDSC(desc_2218 + 33, 1648, RTUD(2217));
	IDSC(desc_2218 + 40, 1654, RTUD(2217));
}
