...
static int16 gen_type0_2319 [] = {0,2318,761,-1};
static int16 gen_type1_2319 [] = {0,2318,761,-1};
static int16 gen_type2_2319 [] = {0,2318,761,-1};
static int16 gen_type3_2319 [] = {0,2318,761,-1};
static int16 gen_type4_2319 [] = {0,2318,761,-1};
static int16 gen_type5_2319 [] = {0,2322,761,-1};


static struct desc_info desc_2319[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2318, gen_type0_2319}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2318, gen_type1_2319}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2318, gen_type2_2319}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2318, gen_type3_2319}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2318, gen_type4_2319}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2322, gen_type5_2319}, 
...
void Init2319(void)
{
	IDSC(desc_2319, 0, RTUD(2318));
	IDSC(desc_2319 + 1, 1, RTUD(2318));
	IDSC(desc_2319 + 31, 1590, RTUD(2318));
	IDSC(desc_2319 + 32, 1700, RTUD(2318));
	IDSC(desc_2319 + 33, 1648, RTUD(2318));
	IDSC(desc_2319 + 40, 1654, RTUD(2318));
}
