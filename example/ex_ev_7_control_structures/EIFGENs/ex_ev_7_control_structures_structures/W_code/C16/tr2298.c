/*
 * Code for class TRAVERSABLE_SUBSET [REFERENCE]
 */
...
extern EIF_UNION Fedb_nl(EIF_REFERENCE, EIF_UNION);
extern void Fedapsc(EIF_REFERENCE, EIF_UNION);
extern EIF_UNION Fec3lhi(EIF_REFERENCE, EIF_UNION);
extern void Fec91uq(EIF_REFERENCE, EIF_UNION);
extern void Fec730v(EIF_REFERENCE, EIF_UNION);
extern void Fec9ew3(EIF_REFERENCE, EIF_UNION);
extern EIF_UNION Fec38e4(EIF_REFERENCE, EIF_UNION);
extern void Fm4amlm(EIF_REFERENCE, int);
...
EIF_UNION Fedb_nl (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("subset_strategy", RTUD(2297), Current, 0, 1, 27298);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	ur1 = RTCCL(tr1);
	ur2 = RTCCL(arg1);
	Result = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE, EIF_UNION, EIF_UNION)) RTWPF(139, 6, dtype))(Current, ur1x, ur2x)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
	RTVI2(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTLE;
...
void Fedapsc (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION up1x = {0, SK_POINTER};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("subtract", RTUD(2297), Current, 0, 1, 27297);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) !tc1) {
		...
		while (!(tc1)) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWPF(139, 0, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
			ur1 = RTCCL(tr1);
			tc2 = (((FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE, EIF_UNION)) RTVPF(39, 0, "has", arg1))(arg1, ur1x)).value.EIF_BOOLEAN_value);
			if (tc2) {
				RTHOOK(8);
...
EIF_UNION Fec3lhi (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAA("disjoint", RTUD(2297), Current, 1, 1, 27291);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
void Fec91uq (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION up1x = {0, SK_POINTER};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("intersect", RTUD(2297), Current, 0, 1, 27296);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
void Fec730v (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAA("merge", RTUD(2297), Current, 1, 1, 27294);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	RTHOOK(3);
	{
		static int16 typarr [] = {2297,1428,-8,1,-1};
		int16 typres;

		typres = RTCID2(NULL, dftype, 1428, typarr);
	...
	while (!(tc1)) {
		...
		ur1 = RTCCL(tr1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWPF(131, 4, dtype))(Current, ur1x);
		RTHOOK(9);
...
void Fec9ew3 (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAA("symdif", RTUD(2297), Current, 1, 1, 27295);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
EIF_UNION Fec38e4 (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION up1x = {0, SK_POINTER};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("is_subset", RTUD(2297), Current, 0, 1, 27292);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
void Fm4amlm (EIF_REFERENCE Current, int where)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_CHARACTER tc1;
