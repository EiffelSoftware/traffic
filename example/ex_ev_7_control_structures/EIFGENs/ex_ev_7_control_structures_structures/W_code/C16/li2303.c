/*
 * Code for class LINKED_SET [REFERENCE]
 */
...
extern void Femv7j4(EIF_REFERENCE, EIF_UNION);
extern void Femwvhr(EIF_REFERENCE, EIF_UNION);
extern void Femxifd(EIF_REFERENCE, EIF_UNION);
...
void Femv7j4 (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("put", RTUD(2302), Current, 0, 1, 27507);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	if (tc3) {
		RTHOOK(3);
		ur1 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWPF(179, 1, dtype))(Current, ur1x);
	}
...
void Femwvhr (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION ur1x = {0, SK_REF};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("extend", RTUD(2302), Current, 0, 1, 27508);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
void Femxifd (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION ur1x = {0, SK_REF};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("prune", RTUD(2302), Current, 0, 1, 27509);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWPF(179, 2, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
