/*
 * Class SUBSET_STRATEGY_GENERIC [REFERENCE]
 */
...
static int16 gen_type0_2302 [] = {0,2301,-8,1,-1};
static int16 gen_type1_2302 [] = {0,2301,-8,1,-1};
static int16 gen_type2_2302 [] = {0,2301,-8,1,-1};
static int16 gen_type3_2302 [] = {0,2301,-8,1,-1};


static struct desc_info desc_2302[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2301, gen_type0_2302}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2301, gen_type1_2302}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2301, gen_type2_2302}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2301, gen_type3_2302}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27139, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27140, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2302(void);
void Init2302(void)
{
	IDSC(desc_2302, 0, RTUD(2301));
	IDSC(desc_2302 + 1, 1, RTUD(2301));
	IDSC(desc_2302 + 31, 64, RTUD(2301));
}
