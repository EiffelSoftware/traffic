/*
 * Class SUBSET_STRATEGY [REFERENCE]
 */
...
static int16 gen_type0_2300 [] = {0,2299,-8,1,-1};
static int16 gen_type1_2300 [] = {0,2299,-8,1,-1};
static int16 gen_type2_2300 [] = {0,2299,-8,1,-1};
static int16 gen_type3_2300 [] = {0,2299,-8,1,-1};


static struct desc_info desc_2300[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2299, gen_type0_2300}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2299, gen_type1_2300}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2299, gen_type2_2300}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2299, gen_type3_2300}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init2300(void);
void Init2300(void)
{
	IDSC(desc_2300, 0, RTUD(2299));
	IDSC(desc_2300 + 1, 1, RTUD(2299));
}
