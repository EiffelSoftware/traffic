/*
 * Code for class SUBSET [REFERENCE]
 */
...
extern EIF_UNION Fecx34b(EIF_REFERENCE, EIF_UNION);
extern void Fec0ctf(EIF_REFERENCE, EIF_UNION);
extern EIF_UNION Fecxg6p(EIF_REFERENCE, EIF_UNION);
...
EIF_UNION Fecx34b (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAA("disjoint", RTUD(2298), Current, 1, 1, 27282);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
void Fec0ctf (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAA("symdif", RTUD(2298), Current, 1, 1, 27280);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
EIF_UNION Fecxg6p (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
	EIF_UNION ur1x = {0, SK_REF};
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("is_superset", RTUD(2298), Current, 0, 1, 27281);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
