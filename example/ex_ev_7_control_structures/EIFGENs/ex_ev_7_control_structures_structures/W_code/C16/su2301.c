/*
 * Code for class SUBSET_STRATEGY_HASHABLE [REFERENCE]
 */
...
extern void Fd0w1cp(EIF_REFERENCE, EIF_UNION, EIF_UNION);
extern EIF_UNION Fd0wee2(EIF_REFERENCE, EIF_UNION, EIF_UNION);
...
void Fd0w1cp (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_INT32, &loc3);
	RTLU(SK_BOOL, &loc4);
	RTEAA("symdif", RTUD(2300), Current, 4, 2, 27136);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	RTHOOK(3);
	{
		static int16 typarr [] = {2300,1423,-8,1,737,-1};
		int16 typres;

		typres = RTCID2(NULL, Dftype(Current), 1423, typarr);
	...
	while (!(tc2)) {
		...
		if (tc3) {
			...
			if (tc3) {
				...
				tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVPF(139, 0, "item", arg2))(arg2)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
				ur1 = RTCCL(tr1);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVPF(87, 2, "found_item", loc1))(loc1)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
				ur2 = RTCCL(tr2);
				...
				tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVPF(139, 0, "item", arg2))(arg2)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVPF(87, 2, "found_item", loc1))(loc1)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
				loc4 = (EIF_BOOLEAN)RTCEQ(tr1, tr2);
			}
	...
	while (!(tc3)) {
		RTHOOK(29);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVPF(87, 6, "item_for_iteration", loc1))(loc1)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		ur1 = RTCCL(tr1);
...
EIF_UNION Fd0wee2 (EIF_REFERENCE Current, EIF_UNION arg1x, EIF_UNION arg2x)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF, &loc2);
	RTLU(SK_INT32, &loc3);
	RTEAA("disjoint", RTUD(2300), Current, 3, 2, 27135);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
