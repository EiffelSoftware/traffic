/*
 * Class DS_CONTAINER [CHARACTER_8]
 */
...
static int16 gen_type0_2322 [] = {0,2321,761,-1};
static int16 gen_type1_2322 [] = {0,2321,761,-1};
static int16 gen_type2_2322 [] = {0,2321,761,-1};
static int16 gen_type3_2322 [] = {0,2321,761,-1};
static int16 gen_type4_2322 [] = {0,2321,761,-1};


static struct desc_info desc_2322[] = {
	{(BODY_INDEX) 29152, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2321, gen_type0_2322}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2321, gen_type1_2322}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2321, gen_type2_2322}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2321, gen_type3_2322}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29153, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2321, gen_type4_2322}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
};
extern void Init2322(void);
void Init2322(void)
{
	IDSC(desc_2322, 0, RTUD(2321));
	IDSC(desc_2322 + 1, 1, RTUD(2321));
	IDSC(desc_2322 + 31, 1654, RTUD(2321));
	IDSC(desc_2322 + 35, 1700, RTUD(2321));
	IDSC(desc_2322 + 36, 1590, RTUD(2321));
}
