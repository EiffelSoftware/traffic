/*
 * Class DS_SEARCHABLE [CHARACTER_8]
 */
...
static int16 gen_type0_2321 [] = {0,2320,761,-1};
static int16 gen_type1_2321 [] = {0,2320,761,-1};
static int16 gen_type2_2321 [] = {0,2320,761,-1};
static int16 gen_type3_2321 [] = {0,2320,761,-1};
static int16 gen_type4_2321 [] = {0,2320,761,-1};
static int16 gen_type5_2321 [] = {0,2322,761,-1};


static struct desc_info desc_2321[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2320, gen_type0_2321}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2320, gen_type1_2321}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2320, gen_type2_2321}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2320, gen_type3_2321}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2320, gen_type4_2321}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) 2322, gen_type5_2321}, 
...
void Init2321(void)
{
	IDSC(desc_2321, 0, RTUD(2320));
	IDSC(desc_2321 + 1, 1, RTUD(2320));
	IDSC(desc_2321 + 31, 1700, RTUD(2320));
	IDSC(desc_2321 + 32, 1648, RTUD(2320));
	IDSC(desc_2321 + 39, 1654, RTUD(2320));
	IDSC(desc_2321 + 43, 1590, RTUD(2320));
}
