...
static int16 gen_type0_2093 [] = {0,1462,774,-1};
static int16 gen_type1_2093 [] = {0,1462,774,-1};
static int16 gen_type2_2093 [] = {0,1462,774,-1};
static int16 gen_type3_2093 [] = {0,1462,774,-1};
static int16 gen_type4_2093 [] = {0,1438,737,-1};


static struct desc_info desc_2093[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2092, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2092, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2092, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2092, (int16 *) 0}, 
	...
	{(BODY_INDEX) 26795, (BODY_INDEX) -1, (int16) 1462, gen_type0_2093}, 
	{(BODY_INDEX) 26796, (BODY_INDEX) -1, (int16) 1462, gen_type1_2093}, 
	{(BODY_INDEX) 26797, (BODY_INDEX) -1, (int16) 1462, gen_type2_2093}, 
	{(BODY_INDEX) 26798, (BODY_INDEX) -1, (int16) 1462, gen_type3_2093}, 
	{(BODY_INDEX) 26799, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26800, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26801, (BODY_INDEX) -1, (int16) 1438, gen_type4_2093}, 
...
void Init2093(void)
{
	IDSC(desc_2093, 0, RTUD(2092));
	IDSC(desc_2093 + 1, 1, RTUD(2092));
	IDSC(desc_2093 + 31, 1684, RTUD(2092));
	IDSC(desc_2093 + 45, 1834, RTUD(2092));
	IDSC(desc_2093 + 53, 198, RTUD(2092));
	IDSC(desc_2093 + 55, 1763, RTUD(2092));
	IDSC(desc_2093 + 59, 1768, RTUD(2092));
	IDSC(desc_2093 + 71, 1769, RTUD(2092));
}
