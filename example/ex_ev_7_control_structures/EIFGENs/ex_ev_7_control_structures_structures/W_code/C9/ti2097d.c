...
static struct desc_info desc_2097[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2096, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2096, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2096, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2096, (int16 *) 0}, 
...
void Init2097(void)
{
	IDSC(desc_2097, 0, RTUD(2096));
	IDSC(desc_2097 + 1, 1, RTUD(2096));
	IDSC(desc_2097 + 31, 1763, RTUD(2096));
	IDSC(desc_2097 + 35, 1690, RTUD(2096));
	IDSC(desc_2097 + 44, 1692, RTUD(2096));
	IDSC(desc_2097 + 50, 1624, RTUD(2096));
	IDSC(desc_2097 + 60, 1625, RTUD(2096));
}
