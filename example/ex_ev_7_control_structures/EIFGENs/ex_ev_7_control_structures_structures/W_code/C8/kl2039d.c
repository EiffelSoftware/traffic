...
static struct desc_info desc_2039[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2038, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2038, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2038, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2038, (int16 *) 0}, 
...
void Init2039(void)
{
	IDSC(desc_2039, 0, RTUD(2038));
	IDSC(desc_2039 + 1, 1, RTUD(2038));
	IDSC(desc_2039 + 31, 1541, RTUD(2038));
	IDSC(desc_2039 + 35, 1580, RTUD(2038));
}
