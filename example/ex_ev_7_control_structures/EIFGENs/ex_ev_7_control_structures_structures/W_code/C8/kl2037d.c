...
static struct desc_info desc_2037[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2036, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2036, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2036, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2036, (int16 *) 0}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 29143, (BODY_INDEX) -1, (int16) 2036, (int16 *) 0}, 
};
extern void Init2037(void);
void Init2037(void)
{
	IDSC(desc_2037, 0, RTUD(2036));
	IDSC(desc_2037 + 1, 1590, RTUD(2036));
	IDSC(desc_2037 + 2, 1, RTUD(2036));
	IDSC(desc_2037 + 32, 1700, RTUD(2036));
}
