...
extern EIF_UNION Fovu_2m(EIF_REFERENCE, EIF_UNION);
extern EIF_UNION Fovwywh(EIF_REFERENCE);
...
EIF_UNION Fovu_2m (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("absolute_time", RTUD(2037), Current, 0, 1, 29144);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
EIF_UNION Fovwywh (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = (EIF_REFERENCE) 0;
	...
	RTLU (SK_REF, &Result);
	RTLU (SK_REF, &Current);
	RTEAA("prefix \"+\"", RTUD(2037), Current, 0, 0, 29145);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
