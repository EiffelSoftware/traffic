...
static struct desc_info desc_2032[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2031, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2031, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2031, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2031, (int16 *) 0}, 
...
void Init2032(void)
{
	IDSC(desc_2032, 0, RTUD(2031));
	IDSC(desc_2032 + 1, 1, RTUD(2031));
	IDSC(desc_2032 + 31, 1617, RTUD(2031));
	IDSC(desc_2032 + 32, 1794, RTUD(2031));
}
