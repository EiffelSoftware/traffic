/*
 * Code for class TRAFFIC_SCHEDULE_LOADER
 */
...
extern void Fo8twqe(EIF_REFERENCE, EIF_UNION);
extern void Fo8y17d(EIF_REFERENCE);
extern void Fo8ujn0(EIF_REFERENCE);
...
void Fo8twqe (EIF_REFERENCE Current, EIF_UNION arg1x)
{
	GTCX
	RTEX;
...
#define arg1 arg1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF,&arg1);
	RTLU (SK_REF, &Current);
	RTEAA("make", RTUD(2041), Current, 0, 1, 30326);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
...
body:;
	...
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
	RTNHOOK(2);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up2x.type == SK_REF)? (EIF_REFERENCE) 0: (up2x.value.EIF_REFERENCE_value = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.value.EIF_REFERENCE_value);
	RTNHOOK(2);
	ur1 = RTCCL(arg1);
	...
	if ((EIF_BOOLEAN) !tc1) {
		RTHOOK(3);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 14, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		RTNHOOK(3);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 14, dtype))(Current)), ((up2x.type == SK_REF)? (EIF_REFERENCE) 0: (up2x.value.EIF_REFERENCE_value = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.value.EIF_REFERENCE_value);
		RTNHOOK(3);
		...
		ui4_1 = ti4_1;
		{
			static int16 typarr [] = {2041,-7,1,726,774,-1};
			int16 typres;
		...
		tr3 = ((up2x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up2x.type == SK_REF)? (EIF_REFERENCE) 0: (up2x.value.EIF_REFERENCE_value = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.value.EIF_REFERENCE_value);
		RTNHOOK(3);
		ur1 = RTCCL(arg1);
		...
		RTHOOK(4);
		*(EIF_BOOLEAN *)(Current + RTWA(2041, 96, dtype)) = (EIF_BOOLEAN)(EIF_BOOLEAN) 1;
	} else {
		RTHOOK(5);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		RTNHOOK(5);
	...
	if ((EIF_BOOLEAN) !tc1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(2041, 96, dtype)) = (EIF_BOOLEAN)(EIF_BOOLEAN) 1;
		...
		RTAR(Current, tr2);
		*(EIF_REFERENCE *)(Current + RTWA(2041, 99, dtype)) = (EIF_REFERENCE)RTCCL(tr2);
		RTHOOK(9);
		RTAR(Current, arg1);
		*(EIF_REFERENCE *)(Current + RTWA(2041, 100, dtype)) = (EIF_REFERENCE)RTCCL(arg1);
		RTHOOK(10);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		RTNHOOK(10);
		tr2 = *(EIF_REFERENCE *)(Current + RTWA(2041, 99, dtype));
		ur1 = RTCCL(tr2);
		tr3 = ((up2x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up2x.type == SK_REF)? (EIF_REFERENCE) 0: (up2x.value.EIF_REFERENCE_value = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.value.EIF_REFERENCE_value);
		RTNHOOK(10);
		tr4 = *(EIF_REFERENCE *)(Current + RTWA(2041, 100, dtype));
		ur2 = RTCCL(tr4);
		...
		RTAR(Current, tr2);
		*(EIF_REFERENCE *)(Current + RTWA(2041, 101, dtype)) = (EIF_REFERENCE)RTCCL(tr2);
		RTHOOK(11);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		RTNHOOK(11);
		tr2 = *(EIF_REFERENCE *)(Current + RTWA(2041, 99, dtype));
		...
		tr2 = ((up2x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE, EIF_UNION, EIF_UNION)) RTVF(2079, 78, "pathname", tr1))(tr1, ur1x, ur2x)), ((up2x.type == SK_REF)? (EIF_REFERENCE) 0: (up2x.value.EIF_REFERENCE_value = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.value.EIF_REFERENCE_value);
		RTAR(Current, tr2);
		*(EIF_REFERENCE *)(Current + RTWA(2041, 98, dtype)) = (EIF_REFERENCE)RTCCL(tr2);
		RTHOOK(12);
		*(EIF_BOOLEAN *)(Current + RTWA(2041, 96, dtype)) = (EIF_BOOLEAN)(EIF_BOOLEAN) 0;
		RTHOOK(13);
		tr1 = RTLNSMART(RTWCT(2041, 97, Current));
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(1806, 31, Dtype(tr1)))(tr1);
		RTNHOOK(13);
		RTCI2(tr1);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(2041, 97, dtype)) = (EIF_REFERENCE)RTCCL(tr1);
	}}
...
void Fo8y17d (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define ur1 ur1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAA("get_from_xml", RTUD(2041), Current, 2, 0, 30328);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
	if (RTAL & CK_REQUIRE | RTAC) {
		...
		tc1 = '\0';
		tr1 = *(EIF_REFERENCE *)(Current + RTWA(2041, 100, dtype));
		if ((EIF_BOOLEAN)(tr1 != NULL)) {
			tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
			RTNHOOK(1);
			tr2 = *(EIF_REFERENCE *)(Current + RTWA(2041, 100, dtype));
			ur1 = RTCCL(tr2);
...
body:;
	...
	tr1 = RTLN(RTUD(2083));
	ur1 = RTCCL(loc1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWF(2083, 97, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(3);
	RTCI2(tr1);
	...
	tr1 = *(EIF_REFERENCE *)(Current + RTWA(2041, 100, dtype));
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTVF(2083, 39, "set_file_name", loc2))(loc2, ur1x);
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2083, 55, "parse", loc2))(loc2);

	RTHOOK(6);
	tc1 = (((FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVF(2083, 98, "can_process", loc2))(loc2)).value.EIF_BOOLEAN_value);
	if (tc1) {
		RTHOOK(7);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2083, 99, "process", loc2))(loc2);
	}


	RTHOOK(8);
	tc1 = (((FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVF(2083, 63, "has_error", loc2))(loc2)).value.EIF_BOOLEAN_value);
	if (tc1) {
		RTHOOK(9);
		*(EIF_BOOLEAN *)(Current + RTWA(2041, 96, dtype)) = (EIF_BOOLEAN)(EIF_BOOLEAN) 1;
		RTHOOK(10);
		...
		tr2 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTVF(2083, 54, "error_description", loc2))(loc2)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		ur1 = RTCCL(tr2);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE, EIF_UNION)) RTVPF(13, 63, "infix \"+\"", tr1))(tr1, ur1x)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		ur1 = RTCCL(tr2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_UNION)) RTWF(2041, 93, dtype))(Current, ur1x);
	} else {
		RTHOOK(11);
		RTAR(Current, loc1);
		*(EIF_REFERENCE *)(Current + RTWA(2041, 97, dtype)) = (EIF_REFERENCE)RTCCL(loc1);
		RTHOOK(12);
		*(EIF_BOOLEAN *)(Current + RTWA(2041, 96, dtype)) = (EIF_BOOLEAN)(EIF_BOOLEAN) 0;
	}
...
void Fo8ujn0 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define ur1 ur1x.value.EIF_REFERENCE_value
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAA("load_schedule", RTUD(2041), Current, 2, 0, 30327);
	RTGC;
	RTSA(dtype);
	RTSC;
	RTIV2(Current, RTAL);
	...
	RTHOOK(1);
	tc1 = *(EIF_BOOLEAN *)(Current + RTWA(2041, 96, dtype));
	if ((EIF_BOOLEAN) !tc1) {
		RTHOOK(2);
		tr1 = RTLN(RTUD(557));
		tr2 = *(EIF_REFERENCE *)(Current + RTWA(2041, 99, dtype));
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_UNION, (EIF_REFERENCE)) RTWF(2041, 89, dtype))(Current)), ((up1x.type == SK_REF)? (EIF_REFERENCE) 0: (up1x.value.EIF_REFERENCE_value = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.value.EIF_REFERENCE_value);
		RTNHOOK(3);
		tr2 = *(EIF_REFERENCE *)(Current + RTWA(2041, 98, dtype));
		ur1 = RTCCL(tr2);
		...
		RTHOOK(5);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2041, 102, dtype))(Current);
	}
