...
static struct desc_info desc_2106[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2105, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2105, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2105, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2105, (int16 *) 0}, 
...
void Init2106(void)
{
	IDSC(desc_2106, 0, RTUD(2105));
	IDSC(desc_2106 + 1, 1, RTUD(2105));
	IDSC(desc_2106 + 31, 1758, RTUD(2105));
	IDSC(desc_2106 + 32, 1617, RTUD(2105));
	IDSC(desc_2106 + 33, 1889, RTUD(2105));
	IDSC(desc_2106 + 44, 1893, RTUD(2105));
}
