...
static struct desc_info desc_2003[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2002, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2002, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2002, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2002, (int16 *) 0}, 
...
void Init2003(void)
{
	IDSC(desc_2003, 0, RTUD(2002));
	IDSC(desc_2003 + 1, 1, RTUD(2002));
	IDSC(desc_2003 + 31, 1617, RTUD(2002));
	IDSC(desc_2003 + 32, 1820, RTUD(2002));
	IDSC(desc_2003 + 39, 1901, RTUD(2002));
}
