...
static struct desc_info desc_2031[] = {
	{(BODY_INDEX) 28914, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2030, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2030, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2030, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2030, (int16 *) 0}, 
...
void Init2031(void)
{
	IDSC(desc_2031, 0, RTUD(2030));
	IDSC(desc_2031 + 1, 1, RTUD(2030));
	IDSC(desc_2031 + 31, 1617, RTUD(2030));
	IDSC(desc_2031 + 32, 1794, RTUD(2030));
}
