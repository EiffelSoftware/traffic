...
static struct desc_info desc_2027[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2026, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2026, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2026, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2026, (int16 *) 0}, 
...
void Init2027(void)
{
	IDSC(desc_2027, 0, RTUD(2026));
	IDSC(desc_2027 + 1, 1, RTUD(2026));
	IDSC(desc_2027 + 31, 1590, RTUD(2026));
	IDSC(desc_2027 + 32, 1616, RTUD(2026));
}
