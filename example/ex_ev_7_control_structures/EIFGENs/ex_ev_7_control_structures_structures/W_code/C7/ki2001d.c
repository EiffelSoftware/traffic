...
static int16 gen_type0_2001 [] = {0,1521,761,-1};
...
static struct desc_info desc_2001[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 2000, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 2000, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 2000, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 2000, (int16 *) 0}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 28421, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26489, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26490, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 28423, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 28424, (BODY_INDEX) -1, (int16) 774, (int16 *) 0}, 
	{(BODY_INDEX) 28425, (BODY_INDEX) -1, (int16) 1521, gen_type0_2001}, 
	{(BODY_INDEX) 28426, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28420, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
...
void Init2001(void)
{
	IDSC(desc_2001, 0, RTUD(2000));
	IDSC(desc_2001 + 1, 1, RTUD(2000));
	IDSC(desc_2001 + 31, 1590, RTUD(2000));
	IDSC(desc_2001 + 32, 1746, RTUD(2000));
	IDSC(desc_2001 + 39, 1819, RTUD(2000));
	IDSC(desc_2001 + 47, 1617, RTUD(2000));
}
