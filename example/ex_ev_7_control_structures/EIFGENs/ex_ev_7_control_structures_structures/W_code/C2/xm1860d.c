...
static struct desc_info desc_1860[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1859, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1859, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1859, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1859, (int16 *) 0}, 
	{(BODY_INDEX) 30, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init1860(void);
void Init1860(void)
{
	IDSC(desc_1860, 0, RTUD(1859));
	IDSC(desc_1860 + 1, 1, RTUD(1859));
}
