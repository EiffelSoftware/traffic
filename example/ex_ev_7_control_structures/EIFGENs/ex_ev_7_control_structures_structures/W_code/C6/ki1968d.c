...
static struct desc_info desc_1968[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1967, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1967, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1967, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1967, (int16 *) 0}, 
	...
	{(BODY_INDEX) 26850, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 26851, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 28034, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) -1, (BODY_INDEX)-1, (int16) -1, (int16 *) 0},
	{(BODY_INDEX) 26852, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 26853, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
};
extern void Init1968(void);
void Init1968(void)
{
	IDSC(desc_1968, 0, RTUD(1967));
	IDSC(desc_1968 + 1, 1, RTUD(1967));
	IDSC(desc_1968 + 31, 1792, RTUD(1967));
	IDSC(desc_1968 + 34, 1590, RTUD(1967));
	IDSC(desc_1968 + 35, 1752, RTUD(1967));
}
