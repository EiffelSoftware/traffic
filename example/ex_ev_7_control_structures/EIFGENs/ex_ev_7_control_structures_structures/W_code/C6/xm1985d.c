...
static struct desc_info desc_1985[] = {
	{(BODY_INDEX) 28195, (BODY_INDEX) -1, (int16) -1, (int16 *) 0},
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1984, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1984, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1984, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1984, (int16 *) 0}, 
	...
	{(BODY_INDEX) 28196, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28197, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28198, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28199, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) -1, (BODY_INDEX) 0, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28200, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28201, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28202, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28203, (BODY_INDEX) -1, (int16) 774, (int16 *) 0}, 
	{(BODY_INDEX) 28204, (BODY_INDEX) -1, (int16) -1, (int16 *) 0}, 
	{(BODY_INDEX) 28205, (BODY_INDEX) -1, (int16) 774, (int16 *) 0}, 
	{(BODY_INDEX) 27910, (BODY_INDEX) -1, (int16) 1808, (int16 *) 0}, 
};
extern void Init1985(void);
void Init1985(void)
{
	IDSC(desc_1985, 0, RTUD(1984));
	IDSC(desc_1985 + 1, 1825, RTUD(1984));
	IDSC(desc_1985 + 2, 1, RTUD(1984));
	IDSC(desc_1985 + 32, 1756, RTUD(1984));
	IDSC(desc_1985 + 34, 1758, RTUD(1984));
	IDSC(desc_1985 + 35, 1759, RTUD(1984));
	IDSC(desc_1985 + 36, 1617, RTUD(1984));
	IDSC(desc_1985 + 37, 1947, RTUD(1984));
	IDSC(desc_1985 + 48, 1590, RTUD(1984));
}
