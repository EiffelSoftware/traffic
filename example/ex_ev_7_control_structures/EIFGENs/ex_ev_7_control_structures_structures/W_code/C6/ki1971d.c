...
static struct desc_info desc_1971[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1970, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1970, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1970, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1970, (int16 *) 0}, 
...
void Init1971(void)
{
	IDSC(desc_1971, 0, RTUD(1970));
	IDSC(desc_1971 + 1, 1, RTUD(1970));
	IDSC(desc_1971 + 31, 1751, RTUD(1970));
	IDSC(desc_1971 + 42, 1752, RTUD(1970));
	IDSC(desc_1971 + 54, 1756, RTUD(1970));
	IDSC(desc_1971 + 56, 1590, RTUD(1970));
	IDSC(desc_1971 + 57, 1792, RTUD(1970));
}
