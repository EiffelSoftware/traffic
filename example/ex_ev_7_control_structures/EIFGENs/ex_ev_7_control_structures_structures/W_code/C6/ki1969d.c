...
static struct desc_info desc_1969[] = {
	...
	{(BODY_INDEX) 11, (BODY_INDEX) -1, (int16) 1968, (int16 *) 0}, 
	...
	{(BODY_INDEX) 16, (BODY_INDEX) -1, (int16) 1968, (int16 *) 0}, 
	{(BODY_INDEX) 17, (BODY_INDEX) -1, (int16) 1968, (int16 *) 0}, 
	...
	{(BODY_INDEX) 29, (BODY_INDEX) -1, (int16) 1968, (int16 *) 0}, 
...
void Init1969(void)
{
	IDSC(desc_1969, 0, RTUD(1968));
	IDSC(desc_1969 + 1, 1, RTUD(1968));
	IDSC(desc_1969 + 31, 1590, RTUD(1968));
	IDSC(desc_1969 + 32, 1752, RTUD(1968));
	IDSC(desc_1969 + 44, 1792, RTUD(1968));
}
