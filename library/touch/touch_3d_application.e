...
feature -- Initialization
	...
	make is
		...
		do
			-- Initialise screen
			video_subsystem.set_video_surface_width (touch_window_width)
			video_subsystem.set_video_surface_height (touch_window_height)
			video_subsystem.set_video_bpp (touch_screen_resolution)
