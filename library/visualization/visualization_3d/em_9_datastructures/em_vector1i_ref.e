...
feature -- Initialization
	...
	make_from_tuple( t: TUPLE[INTEGER] ) is
	...
	make_from_reference ( vec: EM_VECTOR1I_REF ) is
...
feature -- Commands
	...
	ew_divided  ( other: like Current ): like Current is
		...
		do
			create result.make( (x/other.x).rounded )
		end
...
feature -- Conversion
	...
	to_reference: EM_VECTOR1I_REF is
