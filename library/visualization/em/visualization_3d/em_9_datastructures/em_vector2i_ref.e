...
feature -- Initialization
	...
	make_from_tuple( t: TUPLE[INTEGER, INTEGER] ) is
	...
	make_from_reference ( vec: EM_VECTOR2I_REF ) is
...
feature -- Commands
	...
	dot_product ( other: like Current ): INTEGER is
	...
	ew_divided  ( other: like Current ): like Current is
		...
		do
			create result.make( (x/other.x).rounded, (y/other.y).rounded )
		end
...
feature -- Conversion
	...
	to_reference: EM_VECTOR2I_REF is
