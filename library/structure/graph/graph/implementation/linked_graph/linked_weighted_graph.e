...
feature -- Access
	...
	edge_item: detachable LINKED_GRAPH_WEIGHTED_EDGE [like item, L] is
			-- Current edge
		do
	...
	edge_from_values (a_start_node, a_end_node: like item; a_label: L; a_weight: REAL): detachable like edge_item is
