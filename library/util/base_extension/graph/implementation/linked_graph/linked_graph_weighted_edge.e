...
feature {NONE} -- Initialization
	...
	make_directed (a_start_node, a_end_node: LINKED_GRAPH_NODE [G, L]; a_label: L; a_weight: REAL) is
	...
	make_undirected (a_start_node, a_end_node: LINKED_GRAPH_NODE [G, L]; a_label: L; a_weight: REAL) is
